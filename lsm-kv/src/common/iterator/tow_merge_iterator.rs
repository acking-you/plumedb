//! Merge iter for supplying to two different type iters
    ...
    > TwoMergeIterator<A, B>
{
    ...
    /// Construct a new ordered iter based on two different ordered iters. note that if A and B
    /// encounter the same key, A's is preferred over
